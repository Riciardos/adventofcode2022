...
fn dynamic_game_input_from_char_input(input_opponent: char, desired_outcome: char) -> GameInput {
...
fn dynamic_game_input(input_opponent: GameInput, desired_game_outcome: GameOutcome) -> GameInput {
